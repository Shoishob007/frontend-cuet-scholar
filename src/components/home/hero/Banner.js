...
//       <Carousel className="mt-3 mb-5" style={{ border: "2px solid red" }}>
...
//               style={{ textAlign: "left", border: "2px solid red" }}
//             >
//               <h1>
//                 Hey,
//                 <span style={{ color: "goldenrod" }}>Welcome</span> <br />
...
//                 of Things, machine learning, artificial intelligence, deep
//                 learning, and other courses to get ready. You'll learn how to
//                 create anything, including games, websites, and apps. Select a
